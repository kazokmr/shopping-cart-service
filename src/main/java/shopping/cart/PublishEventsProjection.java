...
public class PublishEventsProjection {
    ...
    private static AtLeastOnceProjection<Offset, EventEnvelope<ShoppingCart.Event>> createProjectionFor(
            ActorSystem<?> system,
        ...
        // KafkaへのTopicの送信は、least-once(最低１回)戦略で実行する
